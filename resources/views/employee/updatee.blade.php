...
@section('content')
	...
	<form action="{{ route('employees.update', ['id'=>$employee->id]) }}" method="POST">
		...
		<div class="form-group col-lg-3">
			...
			<input type="text" name="salary" value="{{ $employee->salary}}" class="form-control" readonly="readonly" >		
		</div>
		
		<div class="form-group col-lg-3">
			<label for="role">Select a Role</label>
			<select name="role_id"  cols="5" rows="5" class="form-control" readonly="readonly" >
		...
		<div class="form-group col-lg-3">
			...
			<select name="full_time" id="full_time" class="form-control" readonly="readonly">
	...
	<div class="form-group col-lg-3">
		...
		<td>
			<div class="input-group date">
				<label for="datestarted">Date Started: </label>
  				<input type="text" name="datestarted"  id="date" value="{{ $employee->datestarted}}" class="form-control" ><span class="input-group-addon" readonly="readonly"></i></span>
			</div>
		</td>
